...
(function($) {
  ...
  $(".js-data-example-ajax").select2({
    ...
    function formatRepo (repo) {
      ...
      markup += "<div class='select2-result-repository__statistics'>" +
        "<div class='select2-result-repository__forks'><i class='fa fa-flash'></i> " + repo.forks_count + " چنگال</div>" +
        "<div class='select2-result-repository__stargazers'><i class='fa fa-star'></i> " + repo.stargazers_count + " ستاره ها</div>" +
        "<div class='select2-result-repository__watchers'><i class='fa fa-eye'></i> " + repo.watchers_count + " ناظران</div>" +
      "</div>" +
      "</div></div>";
  ...
  $(".single-select-placeholder").select2({
      placeholder: "یک ایالت را انتخاب کنید",
      allowClear: true
  });
  ...
  $('.jquery-selector').on("change", function(){
      ...
      alert("شما انتخاب می کنید " + value);
  });
