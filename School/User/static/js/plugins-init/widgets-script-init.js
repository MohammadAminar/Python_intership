(function($) {
 ...
 var dzChartlist = function(){
	...
	var chartWidget4 = function(){
		...
		let barChartData2 = {
			defaultFontFamily: 'IRANSans',
			labels: ['یک', 'دو', 'سه', 'چهار', 'پنج', 'شش', 'هفت', 'هشت', 'نه', 'ده', 'یازده', 'دوازده', 'سیزده', 'چهارده', 'پانزده', 'شانزده', 'هفتده', 'هشتده', 'نانزده', 'بیست'],
			datasets: [{
				label: 'هزینه',
	...
	var chartWidget9 = function(){
		...
		new Chart(chart_widget_9, {
			type: "line",
			data: {
				labels: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "فروردین", "اردیبهشت", "خرداد", "تیر"],
				datasets: [{
					label: "آمار فروش",
